...
- Multi-task heads (superclass, subclass, brugada)
...
class ECGTransformerRoPE(nn.Module):
    ...
    def __init__(
        ...
        self.head_brugada = nn.Sequential(
    ...
    def forward(self, x: torch.Tensor, return_embeddings: bool = False) -> Dict[str, torch.Tensor]:
        ...
        Args:
            ...
            return_embeddings: If True, return feature embeddings
        ...
        # 5. Multi-Task Heads
        return {
            'superclass': self.head_superclass(global_embedding),
            'subclass': self.head_subclass(global_embedding),
            'brugada': self.head_brugada(global_embedding)
        }
