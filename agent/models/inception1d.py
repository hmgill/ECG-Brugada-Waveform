...
class Inception1D(nn.Module):
    ...
    def __init__(
        ...
        self.stem = nn.Sequential(
            ...
            nn.Dropout(dropout * 0.5)  # Lighter dropout in early layers
        )
        ...
        for i in range(num_inception_blocks):
            ...
            # Add dropout after each inception block
            self.inception_blocks.append(nn.Dropout(dropout * 0.6))  # Progressive dropout
