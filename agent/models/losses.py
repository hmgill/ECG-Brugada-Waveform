...
class MultiTaskLoss(nn.Module):
    """
    Multi-task loss combining superclass and subclass tasks.
    ...
    def __init__(
        ...
        # Multi-label classification for subclass (multi-hot, 24 classes incl. BRUG)
    ...
    def forward(
        ...
        Args:
            predictions: Dict with 'superclass' (B, 5) and 'subclass' (B, 24) logits
            targets: Dict with corresponding ground truth labels
            
        Returns:
            Dict with 'total', 'superclass', 'subclass' losses
        """
        losses = {}
...
class MultiTaskFocalLoss(nn.Module):
    ...
    def forward(
        ...
        # Superclass: average focal loss across all 5 classes
        ...
        # Subclass: average focal loss across all 24 classes (incl. BRUG)
